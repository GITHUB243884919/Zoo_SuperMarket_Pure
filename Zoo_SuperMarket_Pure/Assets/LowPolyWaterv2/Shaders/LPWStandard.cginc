...
fraginput vert (vertinput v) {
	...
	float3 worldNormal = cross(pos1.xyz-pos0.xyz, pos2.xyz-pos0.xyz);
	...
	// LPW_NOLIGHT 是 shadowcaster 在用, 暂时不会caster
...
fixed4 frag (fraginput i) : COLOR {
	...
	// #endif
		...
		// 	#endif
		// 	);
		float diff = ShoreBlend(i.screenPos, li.abso);
	#endif
	// float diff = ShoreBlend(i.screenPos, li.abso);

...
namespace Game
{
    ...
    public class LittleAnimal_MS
    {
        ...
        public LittleAnimal_MS()
        {
        }
        public LittleAnimal_MS(AnimalState state, int level = 0)
        {
    ...
    public class PlayerAnimal_MS
    {
        ...
        /// 动物ID对应的的动物数据类
        /// </summary>
        public List<LittleAnimal_MS> littleAnimalList = new List<LittleAnimal_MS>();
        ...
        /// <returns></returns>
        public LittleAnimal_MS getPlayerAnimalCell(string key)
        {

...
namespace Game.MessageCenter
{
    ...
    /// 购买商品的消息体
    /// </summary>
    public class SetBuyAnimalObjectData : Message
    {
        /// <summary>
        /// 所属ID　　
        /// 动物栏ID ：
        ...
        public static ObjectPool<SetBuyAnimalObjectData> pool = new ObjectPool<SetBuyAnimalObjectData>();
        /// <summary>
        /// 消息Init 初始化
        /// </summary>
        ...
        /// <returns></returns>
        public static SetBuyAnimalObjectData Send(int messageID, int belongID, int goodsID, 

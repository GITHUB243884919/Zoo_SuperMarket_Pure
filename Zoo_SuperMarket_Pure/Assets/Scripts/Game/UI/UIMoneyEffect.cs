    ...
    public override void Active()
    {
        ...
        switch (m_MoneyType)
        {
            ...
            case MoneyType.Money:
                ...
                //effSprite = ResourceManager.LoadSpriteFromPrefab("UIAtlas/main/Gold");
                var cellScene = Config.sceneConfig.getInstace().getCell(playerData.playerZoo.currSceneID);
                var cellMoney = Config.moneyConfig.getInstace().getCell(cellScene.moneyid);
                effSprite = ResourceManager.LoadSpriteFromPrefab(cellMoney.moneyicon);
                break;

...
namespace Game
{
    ...
    public partial class EntryGateModule : GameModule
    {
        ...
        /// 本场景所有售票口ID列表
        /// </summary>
        public static List<int> sortEntryGateIDs;
        ...
        public override void Init()
        {
            ...
            sortEntryGateIDs = GlobalDataManager.GetInstance().logicTableEntryGate.GetSortGateIDs(playerData.playerZoo.currSceneID);

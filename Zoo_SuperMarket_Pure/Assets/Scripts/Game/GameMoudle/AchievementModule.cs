...
//        {
//            //监听收到收集物品消息
//            MessageManager.GetInstance().Regist((int)GameMessageDefine.SetOpenAnimal, this.OnSetAchievementObjectData);   
//        }
//        //接受消息进行数据修改
//        private void OnSetAchievementObjectData(Message obj)
//        {
//            var _mag = obj as SetBuyAnimalObjectData;
...
//        {
//            MessageManager.GetInstance().UnRegist((int)GameMessageDefine.SetOpenAnimal, this.OnSetAchievementObjectData);

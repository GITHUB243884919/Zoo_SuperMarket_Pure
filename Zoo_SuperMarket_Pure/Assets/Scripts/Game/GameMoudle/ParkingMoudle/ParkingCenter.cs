...
namespace Game
{
    /// <summary>
    /// 停车场模块，包含地上地下
    /// 策划现有的规则，地上来的车，不一定从地上走，这会导致剩余车位牌，显示的和眼见的不符合
    /// </summary>
    public partial class ParkingCenter : GameModule
    {
        ...
        protected void InitGroupParkingData()
        {
            ...
            groundParking.Init(playerData.GetParkingCenterDataIDIndexOfDataIdx().parkingSpaceLevel);
        }

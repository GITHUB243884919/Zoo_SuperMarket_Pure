...
namespace Game
{
    ...
    public class StateShipGoback : FSMState
    {
        ...
        int visitorpathID;
        Config.sceneaddvisitorCell sceneaddvisitorCell;
        public override void Enter(int preStateName)
        {
            ...
            visitorpathID = Config.sceneConfig.getInstace().getCell(sceneID).visitorpath;
            sceneaddvisitorCell = Config.sceneaddvisitorConfig.getInstace().getCell(visitorpathID);
        ...
        protected void TickWait(int deltaTimeMS)
        {
            ...
            if (waitAccumulativeTime >= waitInterval)
            {
                ...
                //返航
                string pathName = sceneaddvisitorCell.outpath;

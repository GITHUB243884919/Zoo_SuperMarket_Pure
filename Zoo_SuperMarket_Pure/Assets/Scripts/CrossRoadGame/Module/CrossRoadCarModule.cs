...
namespace CrossRoadGame
{
    ...
    public class CrossRoadCarModule : GameModule
    {
        ...
        public override void Run()
        {
            ...
            if (multiCD == null)
            {
                ...
                for (int i = 0; i < crossRoadList.Count; i++)
                {
                    ...
                    sParam.minSpeed = crossRoad.minCarSpeed;
                    sParam.maxSpeed = crossRoad.maxCarSpeed;
                    sParam.startPos = crossRoad.startPos;
                    sParam.endPos = crossRoad.endPos;
        ...
        protected void Callback_SpawnCar(IntCD CD, IVoidParam spawnCarParam)
        {
            ...
            float speed = Random.Range(_spawnCarParam.minSpeed, _spawnCarParam.maxSpeed);
            //Debug.LogErrorFormat("speed = {0}, min = {1}, max = {2}",
            //    speed, _spawnCarParam.minSpeed, _spawnCarParam.maxSpeed);
            car.Init(_spawnCarParam.startPos, _spawnCarParam.endPos, speed);

...
namespace Config
{
	public class monitorConfig
	{
		...
		private void InitData(){
			...
			this.AllData.Add("31",new monitorCell("start_star_num","登陆游戏时星星数量"));
			this.AllData.Add("32",new monitorCell("level_star_num","发生改变时星星数量"));
			this.AllData.Add("33",new monitorCell("parking_sceneid","停车场所属场景id"));
			this.AllData.Add("34",new monitorCell("ticket_sceneid","售票口所属场景id"));
		}
	}

...
namespace Config
{
	public class globalConfig
	{
		...
		///游客移动速度
		///<summary>
		public readonly float ZooVisitorSpeed= 10f;  
		///<summary>
		///游客排队移动速度
		///<summary>
		...
		///自然游客小汽车移动速度
		///<summary>
		public readonly float ZooCarSpeed= 25f;  
		///<summary>
		///停车排模型数字显示个位
		///<summary>
		...
		///游客离开移动速度
		///<summary>
		public readonly float ZooVisitorBackSpeed= 10f;  
		///<summary>
		///入口返回路线
		///<summary>
		...
		///动物价格基数
		///<summary>
		public readonly int AnimalPriceBase= 20;  
		///<summary>
		///地面停车场进入基准路
		///<summary>
		...
		///等级上限
		///<summary>
		public readonly int AnimalLvUpLimit= 50;  
		///<summary>
		///售票口未开启图标
		///<summary>
		...
		///利润翻倍广告最大次数
		///<summary>
		public readonly int GoldRewardMaxNumber= 6;  
		///<summary>
		///所有广告奖励合计次数
		///<summary>
		public readonly int AdvertRewardNumber= 6;  
		///<summary>
		///广告合计次数钻石奖励数量
		///<summary>
		public readonly int AdvertRewardRmbNumber= 50;  
		///<summary>
		///利润翻倍广告6次奖励现金时间
		///<summary>
		...
		///利润翻倍广告界面图标
		///<summary>
		public readonly string AdvertProfitDouble= "UIAtlas/UIAdvert/ProfitDouble";  
		///<summary>
		///AppsFlyer开发者KEY
		///<summary>
		...
		///动物培养开启所需星星
		///<summary>
		public readonly int AnimalupgradingNeed= 60;  
		///<summary>
		///游客表情最小缩放
		///<summary>
		...
		///动物栏升级特效路径
		///<summary>
		public readonly string BuildUpEffect2= "prefabs/Effect/Fx_BuildUp";  
		///<summary>
		///新手引导动物栏旋转展示持续时间
		///<summary>
		public readonly int BuildUpShowTime= 5;  
		///<summary>
		///创建账号初始钻石数量
		///<summary>
		public readonly int InitialrmbNumber= 0;  
		///<summary>
		///小游戏恢复体力时间（秒）
		///<summary>
		public readonly float IncreaseOnePointSec= 3600f;  
		///<summary>
		///小游戏体力最大上限
		///<summary>
		public readonly int MaxStrength= 5;  
		///<summary>
		///过马路小游戏场景名称
		///<summary>
		...
		///过马路小游戏场景终点资源路径
		///<summary>
		public readonly string CrossRoadSceneEnd= "prefabs/Little_scene_prefabs/Little_end";  
		///<summary>
		///新手引导游客移动速度
		///<summary>
		public readonly float GuideZooVisitorSpeed= 12f;  
		///<summary>
		///新手引导汽车移动速度
		///<summary>
		public readonly float GuideZooCarSpeed= 40f;  
		///<summary>
		///新手引导售票口售票速度
		///<summary>
		public readonly float GuideTouristSpeed= 2f;  
} 
}
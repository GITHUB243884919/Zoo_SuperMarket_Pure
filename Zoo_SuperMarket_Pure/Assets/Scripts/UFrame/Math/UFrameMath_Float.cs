...
namespace UFrame
{
    public class Math_F
    {
        ...
        public static string OnDounbleToFormatTime_Minute(int isDouble)
        {
            ...
            string str_Minutes = ts.Minutes.ToString("00");
            string str_Seconds = ts.Seconds.ToString("00");

            str = string.Format(str, str_Minutes, str_Seconds);
            return str;
        }

        /// <summary>
        /// double 数据转时间格式（时：分：秒）
        /// </summary>
        /// <param name="isDouble"></param>
        /// <returns></returns>
        public static string OnDounbleToFormatTime_Anhour(int isDouble)
        {
            System.TimeSpan ts = new System.TimeSpan(0, 0, System.Convert.ToInt32(isDouble));
            string str = "{0}:{1}:{2}";
            string str_Hours = ts.Hours.ToString("00");
            string str_Minutes = ts.Minutes.ToString("00");
            string str_Seconds = ts.Seconds.ToString("00");
